...
3. Confirm [Release Compatibility](./docs/release-compatibility.md) reflects the sibling versions tested for this release.
4. Pull the latest `main` branch locally.
5. Validate the release build:
...
7. Monitor the GitHub Actions release workflow and confirm the generated release bundle was attached to the release.
